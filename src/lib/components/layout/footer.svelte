...
<footer class="text-gray-300 body-font hover:text-indigo-500 w-full">
  <div
  ...
  >
    ...
    >
      ...
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav class="list-none mb-10">
          <li><a href="/features#data-storage">Data Storage</a></li>
          <li>
            <a href="/features#asset-monitoring">Asset Monitoring</a>
          </li>
          <li><a href="/features#mobile-app">Mobile App</a></li>
          <li>
            <a href="/features#auto-notifications"> Automatic Notifications</a>
          </li>
  ...
  <div class="bg-gray-100 text-gray-700">
    ...
    >
      ...
      >
        ...
        <a href="https://linkedin.com" class="ml-3">
          <svg
            fill="black"
            stroke="currentColor"
            stroke-linecap="round"
