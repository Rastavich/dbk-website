  ...
  <div class="container px-5 py-24 sm:py-10 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      ...
      <h1 class="sm:text-3xl text-2xl font-medium title-font text-gray-50">
        The app provides the following easy to set up features
      </h1>
    </div>
    <div class="flex flex-wrap -m-4">
        ...
        <div class="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
          ...
          <div class="flex-grow">
            <p class="leading-relaxed text-base">
              React to changes, plan website upgrades and manage the Digital
      ...
      <div class="p-4 md:w-1/3">
        <div class="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
          ...
          <div class="flex-grow">
            <p class="leading-relaxed text-base">
              Monitor and check the availability of your website and emails with
      ...
      <div class="p-4 md:w-1/3">
        <div class="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
          ...
          <div class="flex-grow">
            <p class="leading-relaxed text-base">
              Upgrade to receive Real Time Notifications of website and email
              issues.
            </p>
            <a class="mt-3 text-indigo-300 inline-flex items-center"
              >Learn More
