  ...
  <div class="container px-5 py-24 mx-auto flex flex-wrap">
    ...
    >
      <div class="flex flex-col mb-10 lg:items-start items-center">
        <div
          class="w-12 h-12 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-300 mb-5"
        >
          <svg
            fill="none"
            stroke="currentColor"
        ...
        <div class="flex-grow">
          <h2 class="text-lg title-font font-medium mb-3">Shooting Stars</h2>
          <p class="leading-relaxed text-base text-gray-50">
            Blue bottle crucifix vinyl post-ironic four dollar toast vegan
            taxidermy. Gastropub indxgo juice poutine.
          </p>
          <a
            class="mt-3 text-indigo-300 inline-flex items-center"
            href="/features"
            >Learn More
            <svg
              fill="none"
