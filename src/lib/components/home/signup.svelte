    ...
    <div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
        <div class="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
            <h1 class="title-font font-medium text-3xl">
                Sign up online or in the app to get started with securing your
                Digital Assets
            </h1>
            <p class="leading-relaxed mt-4 text-indigo-300">
                This is the first step to securing your Digital Assets in a
        ...
        <div
            ...
            <div class="relative mb-4">
                <label
                    for="full-name"
                    class="leading-7 text-sm text-gray-600">Full Name</label>
                <input
                    type="text"
                    id="full-name"
                    name="full-name"
            ...
            <p class="text-xs text-gray-500 mt-3">
                By clicking you agree to the Digital Business Keys Terms of
                Service and
