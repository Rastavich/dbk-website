<section class="text-white-500 body-font">
    <div
        ...
        <div
            class="flex flex-col md:pr-10 md:mb-0 mb-8 pr-0 w-full md:w-auto md:text-left text-center">
            <h2
                class="text-xs text-indigo-300 tracking-widest font-medium title-font mb-1">
                DOWNLOAD THE APP
            </h2>
            <h1 class="md:text-3xl text-2xl font-medium title-font">
                Get the Digital Business App on your device.
            </h1>
        </div>
        <div
